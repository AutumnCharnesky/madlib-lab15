var app=angular.module('madMod');
  ...
  app.controller("outputController", function($scope, madFactory) {
    ...
    var story1=["once upon a time there was a {{noun1}} they {{adj1}} and {{verb2}} and {{adj2}} and {{noun2}} and {{noun3}}", "yo {{noun1}} they {{adj1}} yo {{verb2}} and {{adj2}} and {{noun2}} and {{noun3}}"]
